...
<head>
    <meta charset="utf-8" />
    <title>@yield('title_page', 'Sistema Graçã')</title>
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta content="width=device-width, initial-scale=1" name="viewport" />
    <meta content="Sistema para gestão de ingrjas com multi igrejas e controle de filias, celulas, dizimos e ofertas." name="description" />
    <meta content="" name="Graça Sistema" />
    ...
    <link href="{{ asset('admin/assets/global/plugins/pace/themes/pace-theme-flat-top.css') }}" rel="stylesheet" type="text/css" />
    {{-- ESTILOS PAGINAS--}}
    @yield('head')
    @stack('css')
