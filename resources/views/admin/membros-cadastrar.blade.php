...
@section('main-content')
    <div class="row">
            <div id="link-externo">
                <div class="margi">
                    <p> <b>ultilize esse link para enviar este formulario para ser prenchido fora do sistema</b></p>
                    <p> <b>Copie esse link abaixo e envie para o membro preencher esse formulario, com os dados dele.</b></p>
                </div>
                <div class="input-group">
                    <input type="text" class="form-control" value=" " id="copy" readonly style="color: #3c8dbc;">
                    <span class="input-group-btn">
                       <a  data-clipboard-target="#copy"  data-clipboard-action="copy" tabindex="0" class="btn green" role="button" data-toggle="popover" data-trigger="focus" data-content="Copiado!" data-placement="bottom" >Copiar</a>
                       <span  class="btn green-haze" id="gerar-link">Gerar Link</span>
                   </span>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <form  id="form_cadastro" method="POST" enctype="multipart/form-data" action="{{ route('create_membros') }}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="mem_estado_civil" class="form-control select2" value={{ old('mem_estado_civil') }}> 
                                        ...
                                        <div class="col-md-3">
                                            <div class="box box-primary">
                                                <div class="box-body box-profile text-center">
                                                    ...
                                                    <h3 class="profile-mem_foto text-center">{{ Auth::user()->name  }}</h3>
                                                    <p class="text-muted text-center">Membro</p>
                                                    <input name="foto_upload" value="{{ old('foto_upload') }}" type="file" id="file-1" class="inputfile-custom inputfile-1 hidden" data-multiple-caption="{count} files selected"/>
